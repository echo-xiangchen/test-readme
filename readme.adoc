...
I do not use `gradle build` because it casues too much errors. Instead, I use `gradle shadow`. If you can figure something out with `gradle build`, feel free to do so.
